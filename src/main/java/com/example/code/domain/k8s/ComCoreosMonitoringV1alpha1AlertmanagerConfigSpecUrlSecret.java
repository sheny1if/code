 ...
 */
@ApiModel(description = "The secret's key that contains the webhook URL to send HTTP requests to. `urlSecret` takes precedence over `url`. One of `urlSecret` and `url` should be defined. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.")
...
public class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecUrlSecret {
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecUrlSecret key(String key) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecUrlSecret name(String name) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecUrlSecret optional(Boolean optional) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecUrlSecret {\n");
