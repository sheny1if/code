 ...
 */
@ApiModel(description = "SecretKey is the AWS API secret. If blank, the environment variable `AWS_SECRET_ACCESS_KEY` is used.")
...
public class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSigv4SecretKey {
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSigv4SecretKey key(String key) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSigv4SecretKey name(String name) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSigv4SecretKey optional(Boolean optional) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSigv4SecretKey {\n");
