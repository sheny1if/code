...
public class ComCoreosMonitoringV1ThanosRulerSpecScaleIOSecretRef {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;


  public ComCoreosMonitoringV1ThanosRulerSpecScaleIOSecretRef name(String name) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1ThanosRulerSpecScaleIOSecretRef {\n");
