 ...
 */
@ApiModel(description = "The secret's key that contains the PagerDuty service key (when using integration type \"Prometheus\"). Either this field or `routingKey` needs to be defined. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.")
...
public class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecServiceKey {
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecServiceKey key(String key) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecServiceKey name(String name) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecServiceKey optional(Boolean optional) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecServiceKey {\n");
