 ...
 */
@ApiModel(description = "AccessKey is the AWS API key. If blank, the environment variable `AWS_ACCESS_KEY_ID` is used.")
...
public class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSigv4AccessKey {
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSigv4AccessKey key(String key) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSigv4AccessKey name(String name) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSigv4AccessKey optional(Boolean optional) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecSigv4AccessKey {\n");
