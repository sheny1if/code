 ...
 */
@ApiModel(description = "Secret to mount to read bearer token for scraping targets. The secret needs to be in the same namespace as the probe and accessible by the Prometheus Operator.")
...
public class ComCoreosMonitoringV1ProbeSpecBearerTokenSecret {
  ...
  public ComCoreosMonitoringV1ProbeSpecBearerTokenSecret key(String key) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ProbeSpecBearerTokenSecret name(String name) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ProbeSpecBearerTokenSecret optional(Boolean optional) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1ProbeSpecBearerTokenSecret {\n");
