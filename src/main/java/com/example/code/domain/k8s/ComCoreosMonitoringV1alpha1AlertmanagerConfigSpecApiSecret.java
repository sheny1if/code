 ...
 */
@ApiModel(description = "The secret's key that contains the WeChat API key. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.")
...
public class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecApiSecret {
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecApiSecret key(String key) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecApiSecret name(String name) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecApiSecret optional(Boolean optional) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecApiSecret {\n");
