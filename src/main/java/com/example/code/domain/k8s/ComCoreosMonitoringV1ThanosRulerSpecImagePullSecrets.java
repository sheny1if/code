...
public class ComCoreosMonitoringV1ThanosRulerSpecImagePullSecrets {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;


  public ComCoreosMonitoringV1ThanosRulerSpecImagePullSecrets name(String name) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1ThanosRulerSpecImagePullSecrets {\n");
