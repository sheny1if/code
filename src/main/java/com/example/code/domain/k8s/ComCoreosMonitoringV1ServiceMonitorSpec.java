...
import com.example.code.domain.k8s.ComCoreosMonitoringV1ServiceMonitorSpecEndpoints;
import com.example.code.domain.k8s.ComCoreosMonitoringV1ServiceMonitorSpecNamespaceSelector;
import com.example.code.domain.k8s.ComCoreosMonitoringV1ServiceMonitorSpecSelector;
...
public class ComCoreosMonitoringV1ServiceMonitorSpec {
  public static final String SERIALIZED_NAME_ENDPOINTS = "endpoints";
  @SerializedName(SERIALIZED_NAME_ENDPOINTS)
  private List<ComCoreosMonitoringV1ServiceMonitorSpecEndpoints> endpoints = new ArrayList<ComCoreosMonitoringV1ServiceMonitorSpecEndpoints>();
  ...
  private ComCoreosMonitoringV1ServiceMonitorSpecNamespaceSelector namespaceSelector;
  ...
  private ComCoreosMonitoringV1ServiceMonitorSpecSelector selector;
  ...
  public ComCoreosMonitoringV1ServiceMonitorSpec endpoints(List<ComCoreosMonitoringV1ServiceMonitorSpecEndpoints> endpoints) {
    
    this.endpoints = endpoints;
    return this;
  }

  public ComCoreosMonitoringV1ServiceMonitorSpec addEndpointsItem(ComCoreosMonitoringV1ServiceMonitorSpecEndpoints endpointsItem) {
  ...
  **/
  ...
  public List<ComCoreosMonitoringV1ServiceMonitorSpecEndpoints> getEndpoints() {
    return endpoints;
  }


  public void setEndpoints(List<ComCoreosMonitoringV1ServiceMonitorSpecEndpoints> endpoints) {
    this.endpoints = endpoints;
  }


  public ComCoreosMonitoringV1ServiceMonitorSpec jobLabel(String jobLabel) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Chooses the label of the Kubernetes `Endpoints`. Its value will be used for the `job`-label's value of the created metrics.   Default & fallback value: the name of the respective Kubernetes `Endpoint`.")
  ...
  public ComCoreosMonitoringV1ServiceMonitorSpec labelLimit(Long labelLimit) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ServiceMonitorSpec labelNameLengthLimit(Long labelNameLengthLimit) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ServiceMonitorSpec labelValueLengthLimit(Long labelValueLengthLimit) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ServiceMonitorSpec namespaceSelector(ComCoreosMonitoringV1ServiceMonitorSpecNamespaceSelector namespaceSelector) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ServiceMonitorSpecNamespaceSelector getNamespaceSelector() {
    return namespaceSelector;
  }


  public void setNamespaceSelector(ComCoreosMonitoringV1ServiceMonitorSpecNamespaceSelector namespaceSelector) {
    this.namespaceSelector = namespaceSelector;
  }


  public ComCoreosMonitoringV1ServiceMonitorSpec podTargetLabels(List<String> podTargetLabels) {
    
    this.podTargetLabels = podTargetLabels;
    return this;
  }

  public ComCoreosMonitoringV1ServiceMonitorSpec addPodTargetLabelsItem(String podTargetLabelsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "PodTargetLabels transfers labels on the Kubernetes `Pod` onto the created metrics.")
  ...
  public ComCoreosMonitoringV1ServiceMonitorSpec sampleLimit(Long sampleLimit) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ServiceMonitorSpec selector(ComCoreosMonitoringV1ServiceMonitorSpecSelector selector) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ServiceMonitorSpecSelector getSelector() {
    return selector;
  }


  public void setSelector(ComCoreosMonitoringV1ServiceMonitorSpecSelector selector) {
    this.selector = selector;
  }


  public ComCoreosMonitoringV1ServiceMonitorSpec targetLabels(List<String> targetLabels) {
    
    this.targetLabels = targetLabels;
    return this;
  }

  public ComCoreosMonitoringV1ServiceMonitorSpec addTargetLabelsItem(String targetLabelsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "TargetLabels transfers labels from the Kubernetes `Service` onto the created metrics.")
  ...
  public ComCoreosMonitoringV1ServiceMonitorSpec targetLimit(Long targetLimit) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1ServiceMonitorSpec {\n");
