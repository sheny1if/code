 ...
 */
@ApiModel(description = "Define configuration for connecting to alertmanager.  Only available with thanos v0.10.0 and higher.  Maps to the `alertmanagers.config` arg.")
...
public class ComCoreosMonitoringV1ThanosRulerSpecAlertmanagersConfig {
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecAlertmanagersConfig key(String key) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecAlertmanagersConfig name(String name) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecAlertmanagersConfig optional(Boolean optional) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1ThanosRulerSpecAlertmanagersConfig {\n");
