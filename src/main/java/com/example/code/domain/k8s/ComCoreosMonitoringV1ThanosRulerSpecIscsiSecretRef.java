...
public class ComCoreosMonitoringV1ThanosRulerSpecIscsiSecretRef {
  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;


  public ComCoreosMonitoringV1ThanosRulerSpecIscsiSecretRef name(String name) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1ThanosRulerSpecIscsiSecretRef {\n");
