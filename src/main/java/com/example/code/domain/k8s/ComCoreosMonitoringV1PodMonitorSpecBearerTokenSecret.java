 ...
 */
@ApiModel(description = "Secret to mount to read bearer token for scraping targets. The secret needs to be in the same namespace as the pod monitor and accessible by the Prometheus Operator.")
...
public class ComCoreosMonitoringV1PodMonitorSpecBearerTokenSecret {
  ...
  public ComCoreosMonitoringV1PodMonitorSpecBearerTokenSecret key(String key) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1PodMonitorSpecBearerTokenSecret name(String name) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1PodMonitorSpecBearerTokenSecret optional(Boolean optional) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1PodMonitorSpecBearerTokenSecret {\n");
