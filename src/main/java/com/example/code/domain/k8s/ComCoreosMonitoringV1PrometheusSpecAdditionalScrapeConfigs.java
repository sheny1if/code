 ...
 */
@ApiModel(description = "AdditionalScrapeConfigs allows specifying a key of a Secret containing additional Prometheus scrape configurations. Scrape configurations specified are appended to the configurations generated by the Prometheus Operator. Job configurations specified must have the form as specified in the official Prometheus documentation: https://prometheus.io/docs/prometheus/latest/configuration/configuration/#scrape_config. As scrape configs are appended, the user is responsible to make sure it is valid. Note that using this feature may expose the possibility to break upgrades of Prometheus. It is advised to review Prometheus release notes to ensure that no incompatible scrape configs are going to break Prometheus after the upgrade.")
...
public class ComCoreosMonitoringV1PrometheusSpecAdditionalScrapeConfigs {
  ...
  public ComCoreosMonitoringV1PrometheusSpecAdditionalScrapeConfigs key(String key) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1PrometheusSpecAdditionalScrapeConfigs name(String name) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1PrometheusSpecAdditionalScrapeConfigs optional(Boolean optional) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1PrometheusSpecAdditionalScrapeConfigs {\n");
