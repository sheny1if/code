 ...
 */
@ApiModel(description = "Define configuration for connecting to thanos query instances. If this is defined, the QueryEndpoints field will be ignored. Maps to the `query.config` CLI argument. Only available with thanos v0.11.0 and higher.")
...
public class ComCoreosMonitoringV1ThanosRulerSpecQueryConfig {
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecQueryConfig key(String key) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecQueryConfig name(String name) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecQueryConfig optional(Boolean optional) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1ThanosRulerSpecQueryConfig {\n");
