...
public class ComCoreosMonitoringV1ThanosRulerSpecFc {
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecFc fsType(String fsType) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecFc lun(Integer lun) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecFc readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecFc targetWWNs(List<String> targetWWNs) {
    
    this.targetWWNs = targetWWNs;
    return this;
  }

  public ComCoreosMonitoringV1ThanosRulerSpecFc addTargetWWNsItem(String targetWWNsItem) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecFc wwids(List<String> wwids) {
    
    this.wwids = wwids;
    return this;
  }

  public ComCoreosMonitoringV1ThanosRulerSpecFc addWwidsItem(String wwidsItem) {
    if (this.wwids == null) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1ThanosRulerSpecFc {\n");
