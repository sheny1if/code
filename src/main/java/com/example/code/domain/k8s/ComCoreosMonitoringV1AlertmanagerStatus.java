 ...
 */
@ApiModel(description = "Most recent observed status of the Alertmanager cluster. Read-only. Not included when requesting from the apiserver, only from the Prometheus Operator API itself. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status")
...
public class ComCoreosMonitoringV1AlertmanagerStatus {
  ...
  public ComCoreosMonitoringV1AlertmanagerStatus availableReplicas(Integer availableReplicas) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Total number of available pods (ready for at least minReadySeconds) targeted by this Alertmanager cluster.")
  ...
  public ComCoreosMonitoringV1AlertmanagerStatus paused(Boolean paused) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1AlertmanagerStatus replicas(Integer replicas) {
   ...
   * @return replicas
  **/
  @ApiModelProperty(required = true, value = "Total number of non-terminated pods targeted by this Alertmanager cluster (their labels match the selector).")
  ...
  public ComCoreosMonitoringV1AlertmanagerStatus unavailableReplicas(Integer unavailableReplicas) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Total number of unavailable pods targeted by this Alertmanager cluster.")
  ...
  public ComCoreosMonitoringV1AlertmanagerStatus updatedReplicas(Integer updatedReplicas) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Total number of non-terminated pods targeted by this Alertmanager cluster that have the desired version spec.")
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1AlertmanagerStatus {\n");
