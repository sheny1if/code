...
public class ComCoreosMonitoringV1ThanosRulerSpecResources {
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecResources limits(Map<String, Object> limits) {
    
    this.limits = limits;
    return this;
  }

  public ComCoreosMonitoringV1ThanosRulerSpecResources putLimitsItem(String key, Object limitsItem) {
    if (this.limits == null) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1ThanosRulerSpecResources requests(Map<String, Object> requests) {
    
    this.requests = requests;
    return this;
  }

  public ComCoreosMonitoringV1ThanosRulerSpecResources putRequestsItem(String key, Object requestsItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1ThanosRulerSpecResources {\n");
