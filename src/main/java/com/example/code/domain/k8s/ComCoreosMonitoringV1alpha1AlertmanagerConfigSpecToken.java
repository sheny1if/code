 ...
 */
@ApiModel(description = "The secret's key that contains the registered application’s API token, see https://pushover.net/apps. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.")
...
public class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecToken {
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecToken key(String key) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecToken name(String name) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecToken optional(Boolean optional) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecToken {\n");
