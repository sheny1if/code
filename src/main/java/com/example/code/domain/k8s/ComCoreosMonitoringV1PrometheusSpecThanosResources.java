 ...
 */
@ApiModel(description = "Resources defines the resource requirements for the Thanos sidecar. If not provided, no requests/limits will be set")
...
public class ComCoreosMonitoringV1PrometheusSpecThanosResources {
  ...
  public ComCoreosMonitoringV1PrometheusSpecThanosResources limits(Map<String, Object> limits) {
    
    this.limits = limits;
    return this;
  }

  public ComCoreosMonitoringV1PrometheusSpecThanosResources putLimitsItem(String key, Object limitsItem) {
    if (this.limits == null) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1PrometheusSpecThanosResources requests(Map<String, Object> requests) {
    
    this.requests = requests;
    return this;
  }

  public ComCoreosMonitoringV1PrometheusSpecThanosResources putRequestsItem(String key, Object requestsItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1PrometheusSpecThanosResources {\n");
