 ...
 */
@ApiModel(description = "The secret's key that contains the CRAM-MD5 secret. The secret needs to be in the same namespace as the AlertmanagerConfig object and accessible by the Prometheus Operator.")
...
public class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecAuthSecret {
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecAuthSecret key(String key) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecAuthSecret name(String name) {
  ...
  **/
  ...
  public ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecAuthSecret optional(Boolean optional) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ComCoreosMonitoringV1alpha1AlertmanagerConfigSpecAuthSecret {\n");
